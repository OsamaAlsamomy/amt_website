                                    ...
                                    <td>
                                        <label class="switch">
                                            <input type="checkbox" id="state_check" name="state_check"
                                                ...
                                                onclick="change_state('{{ url(App::getLocale() . '/admin/brands/state/' . $key->id) }}' , {{ $key->id }})">
...
<div class="modal fade bd-example-modal-lg" id="add_modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            ...
            <form action="{{ url(App::getLocale() . '/admin/brands/create') }}" method="POST" id="form_add"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="name" class="mr-sm-2">{{ trans('main_trans.brand_name') }}
                                :</label>
                            <input id="name" type="text" name="name" class="form-control" required>
                            <span class="name-error text-danger"></span>
                            <br>
                            <label for="desc" class="mr-sm-2">{{ trans('main_trans.brand_sec') }}
                                :</label>
                        ...
                        <div class="col-md-6">
                            <label for="image" class="mr-sm-2">{{ trans('main_trans.brand_logo') }}
                                :</label>
...
<div class="modal fade bd-example-modal-lg" id="edit_modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url(App::getLocale() . '/admin/brands/edit') }}" method="POST" id="form_edit">
                <div class="modal-body">
...
<div class="modal fade" id="delete_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- add_form -->
                <form action="{{ url(App::getLocale() . '/admin/brands/delete') }}" method="POST"
                    id="form_delete">
                    @csrf
...
<script src="{{ URL::asset('build/assets/js/page/brands.js') }}"></script>
