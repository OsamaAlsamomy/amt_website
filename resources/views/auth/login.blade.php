                ...
                <div class="row justify-content-center no-gutters vertical-align">
                    <div class="col-lg-4 col-md-6 login-fancy-bg bg"
                        ...
                        <div class="login-fancy">
                            <h2 class="text-white mb-20">مرحباً بك</h2>
                            <p class="mb-20 text-white">برنامج ادارة المدارس المقدم من شركة حسام + السمومي  لإدارة المدارس بمختلف تقسيماتها وتوجهاتها</p>
